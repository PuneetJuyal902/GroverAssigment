...
public class AssertionHelper {
	...
	public static void assertToCompareString(String s1, String s2 ,String message){	
	...
	public static void softAssertToCompareStringList(List<String> s1, List<String> s2,String message) {
		SoftAssert softAssertion= new SoftAssert();
		 softAssertion.assertEquals(s1, s2,message);	
		 softAssertion.assertAll();	
